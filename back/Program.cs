...
class Program {
    ...
    static void Main(string[] args)
    {
        ...
        var deck1 = Deck.FromText(g.CardMaster, File.ReadAllText("../decks/darkest_ideas.deck"));
        ...
        var deck2 = Deck.FromText(g.CardMaster, File.ReadAllText("../decks/darkest_ideas.deck"));
